...
describe("ExampleWorkModal, component", () => {
  ...
  let openComponent = shallow(<ExampleWorkModal example={myExample} open={true} closeModal={mockOpenModalFn}/>);
  ...
  it("Should call the close event when close button is clicked", () => {
